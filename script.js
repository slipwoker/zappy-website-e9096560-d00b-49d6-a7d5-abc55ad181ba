document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatedElements.length > 0) {
    ...
    function revealElements() {
      ...
      animatedElements.forEach(function (el) {
        if (!el.getAttribute('data-scroll-animate')) return;
        ...
        if (elementTop < windowHeight - revealPoint) {
          ...
          el.removeAttribute('data-scroll-animate');
        }
      });
    }
  ...
  if (typeof IntersectionObserver !== 'undefined') {
    ...
    animatedElements.forEach(function (el) {
      if (el.getAttribute('data-scroll-animate')) {
        observer.observe(el);
      }
    });
  }
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Diamond Corp. uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e9096560-d00b-49d6-a7d5-abc55ad181ba',
                    name: data.name || '',
                    email: data.email || '',
